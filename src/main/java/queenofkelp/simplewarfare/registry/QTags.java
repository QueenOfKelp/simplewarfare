...
public class QTags {
    ...
    public static final TagKey<DamageType> BULLETPROOF_ARMOR_STOPS = TagKey.of(RegistryKeys.DAMAGE_TYPE, SimpleWarfare.getIdentifier("reduced_by_bulletproof_armor"));
}
